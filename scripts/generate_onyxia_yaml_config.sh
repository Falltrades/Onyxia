...
ONYXIA_CUSTOM_IMAGE=falltrades/onyxia-custom:1.0.0
...
service:
  image:
    ...
    version: inseefrlab/onyxia-vscode-python:py3.13.5
    custom:
      enabled: true
...
extraEnvVars:
  ...
  - name: GITOPS_REPO_BASE_PATH 
    value: ${GITOPS_REPO_BASE_PATH} 
  - name: TP_USER 
    value: ${TP_USER} 
